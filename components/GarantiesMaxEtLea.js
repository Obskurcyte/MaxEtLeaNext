    ...
    <div className={styles.garantiesSupercontainer}>
      ...
      <div className="row" style={{maxWidth: '1200px', margin: '20px auto'}}>
        ...
        <div className="col" style={{minWidth: '170px'}}>
          ...
          <p className={styles.garantiesParagraph}>{t("Garanties9a")}<img src='https://maxandlea.com/wp-content/plugins/sitepress-multilingual-cms/res/flags/fr.png' alt='drapeau français'/>{t("Garanties9b")}</p>
        </div>
        </div>
      </div>
    </React.Fragment>
